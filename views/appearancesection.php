...
class YOUTUBESIDEBAR_AppearanceSection_View extends YOUTUBESIDEBAR_View {
    ...
    */    
    public function postbox_buildmenu_viewintroduction( $data, $box ) {
        ...
        $this->UI->intro_box( 'About Appearance Section', 'Introduction to the Appearance Section to help you understand what tools should be added to this section (by the community) and what sort of tools you can request for this section.', true, __( 'Appearance Tools Ideas', 'youtubesidebar' ), $info_area_content, __( 'Please submit new tool ideas/requests in the WebTechGlobal forum.', 'youtubesidebar' ) );
    }
