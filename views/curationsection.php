...
class YOUTUBESIDEBAR_CurationSection_View extends YOUTUBESIDEBAR_View {
    ...
    */    
    public function postbox_buildmenu_viewintroduction( $data, $box ) {
        ...
        $this->UI->intro_box( 'About Curation Section', 'Introduction to the Curation Section to help you understand what tools should be added to this section (by the community) and what sort of tools you can request for this section.', true, __( 'Curation Tools Ideas', 'youtubesidebar' ), $info_area_content, __( 'Please submit new tool ideas/requests in the WebTechGlobal forum.', 'youtubesidebar' ) );
    }
