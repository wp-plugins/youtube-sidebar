/**
 * JavaScript code for all YouTube Sidebar admin screens, it makes postboxes work
 *
 * @package YouTube Sidebar
 * @subpackage Views JavaScript
 * @author Tobias Bäthge (author of YOUTUBESIDEBAR plugin)
 * @since 3.0.0
 */
...
jQuery( document ).ready( function( $ ) {
	 ...
	 * For YOUTUBESIDEBAR, pagenow has the form "tablepress_{$action}"
	 *
	 * @since 3.0.0
	 */
