...
if($side == 'public'){  
    ...
    require_once('yts_script_admin_jqueryui.php');

    function yts_ADDACTION_admin_init_registered_scripts() {
        global $yts_currentversion;
        $wp_version = yts_get_wp_version();
        ...
        #                                                                                   #
        #####################################################################################
        wp_register_script('jquery-multi-select',WTG_YTS_URL.'wtg-core/wp/script/multi-select-basic/jquery.multi-select.js',array('jquery'));
        wp_register_script('jquery-cookie',WTG_YTS_URL.'wtg-core/wp/script/jquery.cookie.js',array('jquery'));
    }
    ...
    */
    function yts_print_admin_scripts() {
        global $yts_currentversion;
                    
         // $yts_js_switch and similiar variables set in main file
         $yts_js_switch = true;
         if($yts_js_switch == true){

            if( yts_get_wp_version() < '3.6' ){
     ...
     */
    function yts_jquery_opendialog($id){?>
	<script>
	// increase the default animation speed to exaggerate the effect
	$.fx.speeds._default = 1000;
	$(function() {
		$( "#<?php echo WTG_YTS_ABB;?>dialog<?php echo $id;?>" ).dialog({
			autoOpen: false,
			show: "blind",
			hide: "clip",
            modal: false,
		...
		$( "#<?php echo WTG_YTS_ABB;?>opener<?php echo $id;?>" ).click(function() {
			$( "#<?php echo WTG_YTS_ABB;?>dialog<?php echo $id;?>" ).dialog( "open" );
			return false;
		});
	});
	</script><?php
     ...
     */
    function yts_jquery_opendialog_contact($jsform_set){
        ...
        'dialoguebox_id' => WTG_YTS_ABB . 'ERROR',
        'noticebox_content' => '$dialogbox_content has not been set',
        'noticebox_type' => 'question',
        'noticebox_size' => 'Small',
        'form_id' => WTG_YTS_ABB.'form_id_exampleonly',
        'form_name' => WTG_YTS_ABB.'form_name_exampleonly',
        'acceptbutton' => 'Submit',
        'cancelbutton' => 'Cancel',
        ), $jsform_set ) );?>
     ...
     * @param array $formobjects_array (array of form input IDs and related information for building content)
     */
    function yts_jquery_opendialog_confirmformaction($jsform_set,$formobjects_array){
        ...
        'noticebox_type' => 'question',
        'noticebox_size' => 'Small',
        'form_id' => 'yts_form_id_exampleonly',
        'form_name' => 'yts_form_name_exampleonly',
        ), $jsform_set ) );?>
    ...
    */
    function yts_jquery_opendialog_helpbutton($panel_number,$panel_title,$panel_help,$panel_icon,$panel_name,$panel_url){
       global $yts_adm_set;?>
        
        <script>
        $(function() {
            
            $("#yts_helpbutton-<?php echo $panel_number;?>" ).dialog({
                autoOpen: false,
                resizable: true,                
                <?php echo 'height:300,';?>
                <?php echo 'width:800,';?>
            ...
            $( "#yts_opener<?php echo $panel_number;?>" ).click(function() {
                $( "#yts_helpbutton-<?php echo $panel_number;?>" ).dialog( "open" );
                return false;
            });
        });
        </script><?php
    ...
    * @param mixed $panel_name
    */
    function yts_jquery_opendialog_accordianpanel_button($button_type,$panel_number,$panel_title,$panel_help,$panel_icon,$panel_name,$panel_url){
       global $yts_adm_set;?>
        
        <script>
        $(function() {
            
            $("#yts_accordianpanelbutton_<?php echo $panel_number.$button_type;?>" ).dialog({
                autoOpen: false,
                resizable: true,                
                <?php echo 'height:600,';?>
                <?php echo 'width:800,';?>
            ...
            $( "#yts_opener<?php echo $panel_number.$button_type;?>" ).click(function() {
                $( "#yts_accordianpanelbutton_<?php echo $panel_number.$button_type;?>" ).dialog( "open" );
                return false;
            });
        });
        </script><?php
     ...
     */
    function yts_jquerydialog_results($documentlocation = 'default',$buttontext = 'Click Here'){?>

        <script>
        $(function() {
            $( "#<?php echo WTG_YTS_ABB;?>dialogoutcome" ).dialog({
                autoOpen: true,
                resizable: false,
                width:800,
                autoResize: true,
